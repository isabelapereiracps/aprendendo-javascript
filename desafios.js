...
let notaCiencia = 4
let notaMatematica = 4

const notaFinal = (notaCiencia + notaMatematica) / 2;

const passou = notaFinal >= 6

console.log('O aluno passou no final?', passou)

let valorCompra = 35.90
let valorPago = 50
let troco = valorPago - valorCompra

console.log('Valor do troco devolvido:', troco)

let senha1 = '070305'
let senha2 = '070503'

const saoIguais = senha1  === senha2

console.log('As duas senhas são iguais?', saoIguais)
